...
<script type="text/javascript">
	$(document).ready(function() {
        var targetUrl = '${pageContext.request.contextPath}/administrator/user_roles';
        $('.dialog').dialog({
		...
		$('#table tbody').on('click', 'button', function() {
			...
			var userRoleId = data.id;
			var userRole = data.userRole;

			if(buttonId == "btnEdit") {
                $('#dialogEdit').dialog('open');
                $('#formEdit #id').val(userRoleId);
 ...
 <br>
	...
	<div id="dialogCreate" class="dialog" style="display: none" align = "center">
		<form id="formCreate" class="dialogForm" name="formCreate">
			<h3>Create New User Role Form</h3>
			<hr/>
			<input type="text" id="id" name="id" style="display: none">
			<br/>
			<label>User Role: <span>*</span></label>
